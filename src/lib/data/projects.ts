...
export const projects: Project[] = [
    ...
    {
        title: "NYT Solutions [Inactive!]",
        description: "A simple solutions page for the New York Times Games. Made as a fullstack project to practice my skills. Uses Next.js TailwindCSS, and TypeScript. Hosted on Vercel. Inactive due to web vulnerabilities.",
